...
The workflow commits `data/*.json` + regenerated files (`bot: daily catalog 2026-08-17 — 1582 products`), GitHub Pages redeploys in ~1 minute, and every agent's next fetch sees the new catalog. Nothing to click, no dashboard.
...
Zero CSS · zero backend · public JS = 104 + 15 lines ≤ 150 · first load ≈ 20 KB (no images; a category file is 45–200 KB compact JSON, ~10–40 KB gzipped) · Lighthouse mobile Performance 100 / Accessibility 100 on landing and search · rank + render 850 products ≈ 7 ms.
